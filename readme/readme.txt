LICENSE
The portifolio is created by iradukunda josiane and is offered for free use under the open source MIT license for any type and any number of projects.
...
IMAGES
All images are included in the download package and can be reused in  projects. The ones mentioned below come for outside resources. The ones not mentioned come from inside resources like created by Inovatik or purchased special license from authors. Either way you can use them for free in your project if you want.
